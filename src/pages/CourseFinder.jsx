...
export default function CourseFinder() {
  ...
  if (showResults) {
    return <ResultsPage selectedFilters={formData} />
  }
...
function StepContent({ step, formData, setFormData, onNext }) {
  const handleSubmit = (e) => {
    ...
    step.fields.forEach(field => {
      stepData[field] = formElements[field]?.value
    })
        ...
        return (
          <>
            ...
            <div className="mb-6">
              ...
              <div className="flex">
                <select className="p-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-600 mr-2" name="phone">
                  <option>+91</option>
                </select>
                <input
                  type="tel"
            ...
            {formData.englishTest && formData.englishTest !== 'None' && (
              <div className="mb-6">
                ...
                <input
                  ...
                  step="0.5"
                  className="w-full"
                  value={formData.englishScore || 6.5}
                  onChange={(e) =>
                    setFormData({ ...formData, englishScore: e.target.value })
                  }
                />
            ...
            {formData.aptitudeTest && formData.aptitudeTest !== 'None' && (
              <div className="mb-6">
                ...
                <input
                  ...
                  step="10"
                  className="w-full"
                  value={formData.aptitudeScore || 550}
                  onChange={(e) =>
                    setFormData({ ...formData, aptitudeScore: e.target.value })
                  }
                />

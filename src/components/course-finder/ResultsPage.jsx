...
export default function ResultsPage({ selectedFilters }) {
  ...
  const [courses, setCourses] = useState(() => {
    // Apply initial filtering based on selectedFilters
    return mockCourses.filter(course => {
      // Implement your filtering logic here
      return true // For now, return all courses
    })
  })
  const [showSuccessModal, setShowSuccessModal] = useState(false)
  ...
  useEffect(() => {
    // Update courses based on new filters
    setCourses(mockCourses.filter(course => {
      // Implement your filtering logic here
      return true // For now, return all courses
    }))
  }, [filters])
